...
local Constants = {
    ...
    -- Sync Settings
    SYNC = {
        MODE_ONE_WAY_MIRROR = "one_way_mirror",
    ...
    COVER_SIZE_PRESETS = {
        {name = "Compact", description = "8 books per page", ratio = 0.08},
        {
            name = "Regular",
            description = "6 books per page (default)",
            ratio = 0.10
        }, {name = "Large", description = "4 books per page", ratio = 0.15},
        {name = "Extra Large", description = "3 books per page", ratio = 0.20}
    },
