    ...
    return {
        {
            ...
            callback = function() plugin:onShowOPDSPlusCatalog() end
        }, {
            text = _("Sync"),
            callback = function() plugin:onStartOPDSSyncAllCatalogs() end
        }, {
            text = _("Settings"),
            sub_item_table = {
                {
                    ...
                    sub_item_table = {
                        {
                            ...
                            checked_func = function()
                                return
                                    plugin:getSetting("prefer_large_covers") ==
                                        true
                            end,
                            callback = function()
                                local current = plugin:getSetting(
                                                    "prefer_large_covers") ==
                                                    true
                                plugin:saveSetting("prefer_large_covers",
                                                   not current)
                            ...
                            checked_func = function()
                                return
                                    plugin:getSetting("cover_cache_enabled") ~=
                                        false
                            end,
                            callback = function()
                                local current = plugin:getSetting(
                                                    "cover_cache_enabled") ~=
                                                    false
                                plugin:saveSetting("cover_cache_enabled",
                                                   not current)
                                UIManager:show(InfoMessage:new{
                                    text = not current and
                                        _(
                    ...
                    sub_item_table = {
                        {
                            ...
                            callback = function()
                                ...
                                plugin.opds_settings:saveSetting("settings",
                                                                 plugin.settings)
                            ...
                            sub_item_table = {
                                {
                                    text = _("Title Font"),
                                    callback = function()
                                        plugin:showFontSelectionMenu(
                                            "title_font", _("Title Font"))
                                    end
                                }, {
                                    text = _("Title Size"),
                                    callback = function()
                                        plugin:showSizeSelectionMenu(
                                            "title_size", _("Title Font Size"),
                                            12, 24, 16)
                                    end
                                }, {
                                    text = _("Title Bold"),
                            ...
                            sub_item_table = {
                                {
                                    ...
                                    enabled_func = function()
                                        return
                                            not plugin:getSetting(
                                                "use_same_font")
                                    end,
                                    callback = function()
                                        plugin:showFontSelectionMenu(
                                            "info_font", _("Information Font"))
                                    end
                                }, {
                                    text = _("Info Size"),
                                    callback = function()
                                    ...
                                    callback = function()
                                        local current = plugin:getSetting(
                                                            "info_bold")
                                        plugin:saveSetting("info_bold",
                                                           not current)
                                        UIManager:show(InfoMessage:new{
                                            text = not current and
                                                _(
                                                    "Information text is now bold.") or
                                                _(
                                                    "Information text is now regular weight."),
                                            timeout = 2
                                        })
                                    end
                                }, {
                                    ...
                                    sub_item_table = {
                                        {
                                            ...
                                            callback = function()
                                                plugin:saveSetting("info_color",
                                                                   "dark_gray")
                                                UIManager:show(InfoMessage:new{
                                                    text = _(
                                                        "Information text color set to dark gray."),
                                                    timeout = 2
                                                })
                                            end
                                        }, {
                                            ...
                                            callback = function()
                                                ...
                                                UIManager:show(InfoMessage:new{
                                                    text = _(
                                                        "Information text color set to black."),
                                                    timeout = 2
                                                })
                                            end
                                        }
                    ...
                    sub_item_table = {
                        {
                            ...
                            callback = function()
                                plugin.settings.debug_mode = not plugin.settings
                                                                 .debug_mode
                                plugin.opds_settings:saveSetting("settings",
                                                                 plugin.settings)
                                plugin.opds_settings:flush()
